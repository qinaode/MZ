...
namespace ZK.Dal
{
	...
	/// 数据访问类:ADMINLOGS
	/// </summary>
	public partial class ADMINLOGS:IADMINLOGS
	{
		public ADMINLOGS()
		{}
		#region  Method
		...
		public bool Exists(long SID)
		{
			...
			strSql.Append("select count(1) from ADMINLOGS");
		...
		/// 增加一条数据
		/// </summary>
		public long Add(ZK.Model.ADMINLOGS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ADMINLOGS(");
			strSql.Append("ADMINNAME,DESCRIPTION,IPADDR,CREATETIME)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.ADMINLOGS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ADMINLOGS set ");
		...
		public bool Delete(long SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ADMINLOGS ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.ADMINLOGS GetModel(long SID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SID,ADMINNAME,DESCRIPTION,IPADDR,CREATETIME from ADMINLOGS ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
			...
			ZK.Model.ADMINLOGS model=new ZK.Model.ADMINLOGS();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["IPADDR"]!=null && ds.Tables[0].Rows[0]["IPADDR"].ToString()!="")
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SID,ADMINNAME,DESCRIPTION,IPADDR,CREATETIME ");
			strSql.Append(" FROM ADMINLOGS ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" SID,ADMINNAME,DESCRIPTION,IPADDR,CREATETIME ");
			strSql.Append(" FROM ADMINLOGS ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ADMINLOGS T ");
