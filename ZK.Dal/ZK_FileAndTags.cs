...
{
	/// <summary>
	/// 数据访问类:ZK_FileAndTags
	/// </summary>
	public partial class ZK_FileAndTags:IZK_FileAndTags
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(ZK.Model.ZK_FileAndTags model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ZK_FileAndTags(");
			strSql.Append("fileID,tagID)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.ZK_FileAndTags model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ZK_FileAndTags set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ZK_FileAndTags ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.ZK_FileAndTags GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 fileID,tagID from ZK_FileAndTags ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			ZK.Model.ZK_FileAndTags model=new ZK.Model.ZK_FileAndTags();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fileID,tagID ");
			strSql.Append(" FROM ZK_FileAndTags ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ZK_FileAndTags ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ZK_FileAndTags T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "ZK_FileAndTags";
