...
{
	/// <summary>
	/// 数据访问类:miniyun_user_privilege
	/// </summary>
	public partial class miniyun_user_privilege:Iminiyun_user_privilege
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "miniyun_user_privilege"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from miniyun_user_privilege");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into miniyun_user_privilege(");
			strSql.Append("user_id,file_path,permission,created_at,updated_at)");
			strSql.Append(" values (");
			strSql.Append("@user_id,@file_path,@permission,@created_at,@updated_at)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@user_id", MySqlDbType.Int32,11),
					new MySqlParameter("@file_path", MySqlDbType.VarChar,300),
					new MySqlParameter("@permission", MySqlDbType.VarChar,255),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update miniyun_user_privilege set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from miniyun_user_privilege ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		public ZK.Model.miniyun_user_privilege GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,file_path,permission,created_at,updated_at from miniyun_user_privilege ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
			...
			ZK.Model.miniyun_user_privilege model=new ZK.Model.miniyun_user_privilege();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,file_path,permission,created_at,updated_at ");
			strSql.Append(" FROM miniyun_user_privilege ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from miniyun_user_privilege T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
            ...
            //        };
            //parameters[0].Value = "*";
            //parameters[1].Value = "miniyun_user_privilege";
