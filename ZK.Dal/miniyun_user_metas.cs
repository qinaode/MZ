...
{
	/// <summary>
	/// 数据访问类:miniyun_user_metas
	/// </summary>
	public partial class miniyun_user_metas:Iminiyun_user_metas
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "miniyun_user_metas"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from miniyun_user_metas");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into miniyun_user_metas(");
			strSql.Append("user_id,meta_key,meta_value,created_at,updated_at)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update miniyun_user_metas set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from miniyun_user_metas ");
		...
		public ZK.Model.miniyun_user_metas GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,meta_key,meta_value,created_at,updated_at from miniyun_user_metas ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
			...
			ZK.Model.miniyun_user_metas model=new ZK.Model.miniyun_user_metas();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,meta_key,meta_value,created_at,updated_at ");
			strSql.Append(" FROM miniyun_user_metas ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from miniyun_user_metas T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
            ...
            //        };
            //parameters[0].Value = "*";
            //parameters[1].Value = "miniyun_user_metas";
