...
namespace ZK.Dal
{
	...
	/// 数据访问类:ZK_FileJP
	/// </summary>
	public partial class ZK_FileJP:IZK_FileJP
	{
		public ZK_FileJP()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "ZK_FileJP"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from ZK_FileJP");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(ZK.Model.ZK_FileJP model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ZK_FileJP(");
			strSql.Append("typeID,fileID,fileName,fileType,imageURL,sortNum)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.ZK_FileJP model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ZK_FileJP set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ZK_FileJP ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.ZK_FileJP GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,typeID,fileID,fileName,fileType,imageURL,sortNum from ZK_FileJP ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			ZK.Model.ZK_FileJP model=new ZK.Model.ZK_FileJP();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,typeID,fileID,fileName,fileType,imageURL,sortNum ");
			strSql.Append(" FROM ZK_FileJP ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,typeID,fileID,fileName,fileType,imageURL,sortNum ");
			strSql.Append(" FROM ZK_FileJP ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ZK_FileJP T ");
