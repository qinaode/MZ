...
namespace ZK.Dal
{
	...
	/// 数据访问类:JOINRESPONSES
	/// </summary>
	public partial class JOINRESPONSES:IJOINRESPONSES
	{
		public JOINRESPONSES()
		{}
		#region  Method
		...
		public bool Exists(long SID)
		{
			...
			strSql.Append("select count(1) from JOINRESPONSES");
		...
		/// 增加一条数据
		/// </summary>
		public long Add(ZK.Model.JOINRESPONSES model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into JOINRESPONSES(");
			strSql.Append("USERID,CONTENT,AGREE,SENDER,SENDTIME)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@AGREE", SqlDbType.SmallInt,2),
					new SqlParameter("@SENDER", SqlDbType.Int,4),
					new SqlParameter("@SENDTIME", SqlDbType.DateTime)};
			parameters[0].Value = model.USERID;
			parameters[1].Value = model.CONTENT;
			parameters[2].Value = model.AGREE;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.JOINRESPONSES model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update JOINRESPONSES set ");
			strSql.Append("USERID=@USERID,");
			strSql.Append("CONTENT=@CONTENT,");
			strSql.Append("AGREE=@AGREE,");
		...
		public bool Delete(long SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from JOINRESPONSES ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.JOINRESPONSES GetModel(long SID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SID,USERID,CONTENT,AGREE,SENDER,SENDTIME from JOINRESPONSES ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
			...
			ZK.Model.JOINRESPONSES model=new ZK.Model.JOINRESPONSES();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["AGREE"]!=null && ds.Tables[0].Rows[0]["AGREE"].ToString()!="")
				{
					model.AGREE=int.Parse(ds.Tables[0].Rows[0]["AGREE"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SID,USERID,CONTENT,AGREE,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINRESPONSES ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" SID,USERID,CONTENT,AGREE,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINRESPONSES ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from JOINRESPONSES T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "JOINRESPONSES";
