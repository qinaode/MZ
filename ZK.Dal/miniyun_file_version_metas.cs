...
{
	/// <summary>
	/// 数据访问类:miniyun_file_version_metas
	/// </summary>
	public partial class miniyun_file_version_metas:Iminiyun_file_version_metas
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "miniyun_file_version_metas"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from miniyun_file_version_metas");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(ZK.Model.miniyun_file_version_metas model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into miniyun_file_version_metas(");
			strSql.Append("version_id,meta_key,meta_value,created_at,updated_at)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.miniyun_file_version_metas model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update miniyun_file_version_metas set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from miniyun_file_version_metas ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.miniyun_file_version_metas GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,version_id,meta_key,meta_value,created_at,updated_at from miniyun_file_version_metas ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
			...
			ZK.Model.miniyun_file_version_metas model=new ZK.Model.miniyun_file_version_metas();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,version_id,meta_key,meta_value,created_at,updated_at ");
			strSql.Append(" FROM miniyun_file_version_metas ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from miniyun_file_version_metas T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "miniyun_file_version_metas";
