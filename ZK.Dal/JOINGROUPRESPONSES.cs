...
{
	/// <summary>
	/// 数据访问类:JOINGROUPRESPONSES
	/// </summary>
	public partial class JOINGROUPRESPONSES:IJOINGROUPRESPONSES
	{
		...
		public bool Exists(long SID)
		{
			...
			strSql.Append("select count(1) from JOINGROUPRESPONSES");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into JOINGROUPRESPONSES(");
			strSql.Append("USERID,GROUPID,CONTENT,AGREE,SENDER,SENDTIME)");
			...
			parameters[3].Value = model.AGREE;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update JOINGROUPRESPONSES set ");
		...
		public bool Delete(long SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from JOINGROUPRESPONSES ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
		...
		public ZK.Model.JOINGROUPRESPONSES GetModel(long SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SID,USERID,GROUPID,CONTENT,AGREE,SENDER,SENDTIME from JOINGROUPRESPONSES ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
			...
			ZK.Model.JOINGROUPRESPONSES model=new ZK.Model.JOINGROUPRESPONSES();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SID,USERID,GROUPID,CONTENT,AGREE,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINGROUPRESPONSES ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" SID,USERID,GROUPID,CONTENT,AGREE,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINGROUPRESPONSES ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from JOINGROUPRESPONSES T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "JOINGROUPRESPONSES";
