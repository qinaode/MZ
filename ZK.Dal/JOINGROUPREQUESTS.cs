/**  智客知识管理平台。
* JOINGROUPREQUESTS.cs
*
* 功 能： N/A
* 类 名： JOINGROUPREQUESTS
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// 数据访问类:JOINGROUPREQUESTS
	/// </summary>
	public partial class JOINGROUPREQUESTS:IJOINGROUPREQUESTS
	{
		public JOINGROUPREQUESTS()
		{}
		#region  Method
		...
		public bool Exists(long SID)
		{
			...
			strSql.Append("select count(1) from JOINGROUPREQUESTS");
		...
		/// 增加一条数据
		/// </summary>
		public long Add(ZK.Model.JOINGROUPREQUESTS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into JOINGROUPREQUESTS(");
			strSql.Append("USERID,GROUPID,CONTENT,SENDER,SENDTIME)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(ZK.Model.JOINGROUPREQUESTS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update JOINGROUPREQUESTS set ");
		...
		public bool Delete(long SID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from JOINGROUPREQUESTS ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public ZK.Model.JOINGROUPREQUESTS GetModel(long SID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SID,USERID,GROUPID,CONTENT,SENDER,SENDTIME from JOINGROUPREQUESTS ");
			strSql.Append(" where SID=@SID");
			SqlParameter[] parameters = {
					new SqlParameter("@SID", SqlDbType.BigInt)
			};
			...
			ZK.Model.JOINGROUPREQUESTS model=new ZK.Model.JOINGROUPREQUESTS();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SID,USERID,GROUPID,CONTENT,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINGROUPREQUESTS ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" SID,USERID,GROUPID,CONTENT,SENDER,SENDTIME ");
			strSql.Append(" FROM JOINGROUPREQUESTS ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from JOINGROUPREQUESTS T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "JOINGROUPREQUESTS";
