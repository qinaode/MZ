...
namespace ZK.Dal
{
	...
	/// </summary>
	public partial class file_collection:Ifile_collection
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "file_collection"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from file_collection");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into file_collection(");
			strSql.Append("user_id,file_type,parent_file_id,file_create_time,file_update_time,file_name,version_id,fie_size,file_path,is_deleted,mime_type,create_at,updated_at,sort,cuserids,cuseridss,is_end)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@file_create_time", MySqlDbType.Int32,20),
					new MySqlParameter("@file_update_time", MySqlDbType.Int32,20),
					new MySqlParameter("@file_name", MySqlDbType.VarChar,255),
					new MySqlParameter("@version_id", MySqlDbType.Int32,11),
					new MySqlParameter("@fie_size", MySqlDbType.Int32,64),
					new MySqlParameter("@file_path", MySqlDbType.VarChar,500),
					new MySqlParameter("@is_deleted", MySqlDbType.Int32,4),
					...
					new MySqlParameter("@is_end", MySqlDbType.Int32,4)};
			...
			parameters[16].Value = model.is_end;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update file_collection set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from file_collection ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		public ZK.Model.file_collection GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,file_type,parent_file_id,file_create_time,file_update_time,file_name,version_id,fie_size,file_path,is_deleted,mime_type,create_at,updated_at,sort,cuserids,cuseridss,is_end from file_collection ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
			...
			ZK.Model.file_collection model=new ZK.Model.file_collection();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["is_end"]!=null && ds.Tables[0].Rows[0]["is_end"].ToString()!="")
				{
					model.is_end=int.Parse(ds.Tables[0].Rows[0]["is_end"].ToString());
				}
				return model;
			}
			else
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,user_id,file_type,parent_file_id,file_create_time,file_update_time,file_name,version_id,fie_size,file_path,is_deleted,mime_type,create_at,updated_at,sort,cuserids,cuseridss,is_end ");
			strSql.Append(" FROM file_collection ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from file_collection T ");
