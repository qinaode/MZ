...
{
	/// <summary>
	/// 数据访问类:View_TeachFileList
	/// </summary>
	public partial class View_TeachFileList:IView_TeachFileList
	{
		...
		public bool Add(ZK.Model.View_TeachFileList model)
		{
			...
			strSql.Append("insert into View_TeachFileList(");
			strSql.Append("id,fileID,fileName,cateID,catename,fileTypeID,fileTypeName,channelID,channelName,createTime,imageURL,clickNum,isDir,filePath,fileDesc,USERID,USERNAME,CategoryId,CategoryName)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@channelName", SqlDbType.VarChar,4),
			...
			parameters[17].Value = model.CategoryId;
			parameters[18].Value = model.CategoryName;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_TeachFileList set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_TeachFileList ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		public ZK.Model.View_TeachFileList GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,fileID,fileName,cateID,catename,fileTypeID,fileTypeName,channelID,channelName,createTime,imageURL,clickNum,isDir,filePath,fileDesc,USERID,USERNAME,CategoryId,CategoryName from View_TeachFileList ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			ZK.Model.View_TeachFileList model=new ZK.Model.View_TeachFileList();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,fileID,fileName,cateID,catename,fileTypeID,fileTypeName,channelID,channelName,createTime,imageURL,clickNum,isDir,filePath,fileDesc,USERID,USERNAME,CategoryId,CategoryName ");
			strSql.Append(" FROM View_TeachFileList ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_TeachFileList ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_TeachFileList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "*";
			parameters[1].Value = "View_TeachFileList";
