...
function cParticleEmitter() {
    ...
    this.initParticle = function(particle) {
        ...
        // convert to radians
        var vector = Vector.create(Math.cos(newAngle), Math.sin(newAngle));
        ...
        var end = [this.finishColour[0] + this.finishColourRandom[0] * RANDM1TO1(), this.finishColour[1] + this.finishColourRandom[1] * RANDM1TO1(), this.finishColour[2] + this.finishColourRandom[2] * RANDM1TO1(), this.finishColour[3] + this.finishColourRandom[3] * RANDM1TO1()];
