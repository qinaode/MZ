...
var addclassid = $.browser.msie == true ? 'classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' : '';
...
//                                    });
        ...
        onUploadProgress: function (file, fileBytesLoaded, fileTotalBytes) {
            ...
            if ($.inArray('onUploadProgress', settings.overrideEvents) < 0) {
                $('#' + file.id).find(".progress").html(percentage + '%('+this.queueData.averageSpeed + suffix+')');
                $('#' + file.id).find(".progressbar").css('width', percentage + '%');
