                        ...
                        if (item["lessonParent"] == 0) {
                            ...
                            $.each(backdata, function (j, itemlesson) {
                                if (itemlesson["lessonParent"] == item["lessonID"]) {
                                    strhtml = strhtml + "<p><a class='C_Lesson' id='Lesson_" + itemlesson["lessonID"] + "' href='javascript:void(0);return false;' onclick='ChangeCurrentLesson(this.id)'>" + itemlesson["lessonName"] + "</a></p>";
                                }
                            })
                            strhtml = strhtml + "</div>";
                        }
...
<div class="main_wrap">
	<div class="box">
		...
		<div class="box_mind" style="border:thick #0C0">
			<img src="images/xuankuang.jpg" />
    ...
    <div class="picture">
        <p class="tit3">
            <span style="float: left; color: Black;">资源推送 ></span><span class="ino"> 教学资源推送
            </span>
        </p>
        <p class="sort">
