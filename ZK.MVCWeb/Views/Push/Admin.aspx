...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript">
        ...
        function Push_OtherFile() {
            ...
            var channelgroupid = $("#Select_AdminCG").val();
        ...
        <div align="center" class="green2" style="width: 800px; margin-right: auto; margin-left: auto;
            ...
            <table width="85%" align="center" style="padding-bottom: 10px; padding-top: 5px;
                ...
                <tr>
                    ...
                    <td>
                        <select id="Select_AdminCG" style="width: 500px;">
                            <%System.Data.DataTable AdminCGlist = (System.Data.DataTable)ViewData["AdminCGlist"];
                              foreach (System.Data.DataRow item in AdminCGlist.Rows)
                              {
                                  if (item["channelGroupName"].ToString() == "行政分类")
                                  {
                                      continue;
                                  }
                            %>
