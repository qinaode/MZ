    ...
    <div class="div_fileInfo">
        <ul style="margin-left: -10px;" class="Resources">
            ...
            <li style="text-align: center">
                <a target="_parent"  href='/ContentPage/Index?file_id=<%=item.fileID%> &url_flag=Admin' >
                 <div>
                 <div>
                  <% if (item.fileTypeID == 2)
                   {
                       if(item.filePath.ToString().Contains('.'))
                       {
                            ...
                            if (str == "xls" || str == "xlsx")
                            {%> 
                                <img src="../../themes/defaultpic/excel/48.png" style=" border: 0px; width:48px;height:48px;" />
                            <%}
                            else if (str == "doc" || str == "docx")
                            {%> 
                                <img src="../../themes/defaultpic/word/48.png" style=" border: 0px; width:48px;height:48px;" />
                            <%}
                            else if (str == "ppt" || str == "pptx")
                            {%>
                                <img src="../../themes/defaultpic/ppt/48.png" style=" border: 0px; width:48px;height:48px;"/>
                            <%}  
                            else
                                {%>
                                  <img src="../../themes/defaultpic/word/48.png" style="border: 0px;width:48px;height:48px;"/> 
                ...
                <%}
                   ...
                   {%>
                        <img src="<%=item.imageURL%>"  style="height:48px;width:48px; border: 0px;" />
                <% }%>
                    </div>  
                    <div class="resTitle">
