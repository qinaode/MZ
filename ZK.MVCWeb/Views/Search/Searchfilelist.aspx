    ...
    <div class="div_fileInfo" style="margin-top: -10px;">
        <ul style="margin-left: -10px;" class="Resources">
            ...
            <%foreach (var item in allfilemodel)
              {%>
            <li style="text-align: center; margin-left: 56px;"><a target="_parent" href="/ContentPage/Index?file_id=<%=item.fileID%>&url_flag=Search">
                <img src="<%=item.imageURL %>" style="border: 0px; width: 48px; height: 48px;" /> </a>
                <div class="resTitle">
                    <a target="_parent" href="/ContentPage/Index?file_id=<%=item.fileID%>&url_flag=Search" title="<%=item.fileName%>">
