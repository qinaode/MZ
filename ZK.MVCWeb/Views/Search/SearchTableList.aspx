...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .link {
clear:both; height:25px;margin:0 auto;padding-top:30px;float: right; display:inline; 
}
    </style>
    ...
    <div class="warp1">
        <div class="down">
            <div>
                <table width="100%" border="0">
                    <tbody>
                        <tr style="background-color: rgb(240, 248, 252); background-position: initial initial;
                            ...
                            <th width="35%" align="left" scope="col" style="font-family:微软雅黑;">
                                文档名称                            
                             </th>
                ...
                <span class="link" style=" width: 400px">
