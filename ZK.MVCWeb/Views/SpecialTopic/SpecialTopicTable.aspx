                ...
                <table width="100%" border="0">
                    <tbody>
                        <tr style="background-color: rgb(240, 248, 252); background-position: initial initial;
                            ...
                            <th width="10%" scope="col" style="font-family: 微软雅黑;">
                                格式
                            </th>
                            <th width="35%" scope="col" align="left" style="font-family: 微软雅黑;">
                                文档名称
                            </th>
                            <th width="15%" scope="col" style="font-family: 微软雅黑;">
                                上传者
                            </th>
                            <th width="12%" scope="col" style="font-family: 微软雅黑;">
                                下载量
                            </th>
                            <th width="20%" scope="col" style="font-family: 微软雅黑;">
                                上传时间
                            </th>
                        </tr>
                        ...
                        <tr style="height: 34px">
                                ...
                                <div id="Div3">
                                    ...
                                    <div id="Div1">
                                        <%if (Convert.ToInt32(item["fileTypeID"]) == 2)
                                          {
                                              if (item["filePath"].ToString().Contains('.'))
                                              {
                                                  ...
                                                  if (str == "xls" || str == "xlsx")
                                                  {%>
                                        <img src="../../themes/defaultpic/excel/32.png" style="margin-top: 5px; margin-bottom: 5px;"
                                            width="34px" height="34px" />
                                        <%}
                                                  if (str == "doc" || str == "docx")
                                                  {%>
                                        <img src="../../themes/defaultpic/word/32.png" style="margin-top: 5px; margin-bottom: 5px;"
                                            width="34px" height="34px" />
                                        <%}
                                                  if (str == "ppt" || str == "pptx")
                                                  {%>
                                        <img src="../../themes/defaultpic/ppt/32.png" style="margin-top: 5px; margin-bottom: 5px;"
                                            width="34px" height="34px" />
                                        <%}
                                                  else
                                                  {%>
                                        ...
                                        <%if (Convert.ToInt32(item["fileTypeID"]) == 3)
                                          {%>
                                        <img src="../../images/img.png" style="margin-top: 5px; margin-bottom: 5px;" width="34px"
                                            height="34px" />
                                        <%}
                                          else if (Convert.ToInt32(item["fileTypeID"]) == 1)
                                          {%>
                                        <img src="../../images/video.png" style="margin-top: 5px; margin-bottom: 5px;" width="34px"
                                            height="34px" />
                                        <%}
                                          else
                                          {%>
                            ...
                            <td>
                                <div id="Div7" style="float: left;">
                                    <a target="_blank" href='/ContentPage/Index?file_id=<%=item["fileID"] %>&url_flag=Search' title="<%=item["fileName"]%>">
                                     <%if (item["fileName"].ToString().Length > 36)
                                        {%>
                                        <%=item["fileName"].ToString().Substring(0, 36)%>...<%}
                                        else%>
                                       <%=item["fileName"]%>
                                    </a>
                                </div>
