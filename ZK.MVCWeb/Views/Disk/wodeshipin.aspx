...
<body onload="MM_preloadImages('/imagesN/diskImages/fanhui01.png','/imagesN/diskImages/shangchuan01.png','/imagesN/diskImages/xinjianwjj01.png','/imagesN/diskImages/lixianxiazai01.png')">
    ...
    <table width="100%" border="0">
        <tr valign="bottom">
            ...
            <td width="65" height="40">
                <a href="#">
                    <img src="/imagesN/diskImages/fanhui.png" width="63" height="36" border="0" id="Image1"
                        onmouseover="MM_swapImage('Image1','','/imagesN/diskImages/fanhui01.png',1)"
                        onmouseout="MM_swapImgRestore()" /></a>
            </td>
            <td width="80" height="40">
                <a href="javascript:void(0);return false;" onclick="Btn_UploadFiles('pic')">
                    <img src="/imagesN/diskImages/shangchuan.png" width="78" height="36" border="0" id="Image2"
                        onmouseover="MM_swapImage('Image2','','/imagesN/diskImages/shangchuan01.png',1)"
                        onmouseout="MM_swapImgRestore()" /></a>
            </td>
            <td width="99" height="40">
                <a href="javascript:void(0); return false;" onclick="Btn_CreateNewFolder('pic')">
                    <img src="/imagesN/diskImages/xinjianwjj.png" width="97" height="36" border="0" id="Image3"
                        onmouseover="MM_swapImage('Image3','','/imagesN/diskImages/xinjianwjj01.png',1)"
                        onmouseout="MM_swapImgRestore()" /></a>
            </td>
            ...
            <td width="14" height="40">
                &nbsp;<a href="/Disk/wodeshipin01"><img src="/imagesN/diskImages/liebiao_01.png"
                    width="12" height="12" border="0" /></a>
            </td>
            <td width="14" height="40">
                &nbsp;<a href="/Disk/wodeshipin"><img src="/imagesN/diskImages/liebiao_03.png" width="12"
    ...
    <iframe id="iframe_content" flag="/Disk/content_pic?_type=video&parent_id=0" frameborder="0"
