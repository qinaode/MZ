...
namespace ZK.BLL
{
	...
	{
		private readonly IZK_FileVisitors dal=DataAccess.CreateZK_FileVisitors();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.ZK_FileVisitors GetModelByCache(int ID)
		{
			
			string CacheKey = "ZK_FileVisitorsModel-" + ID;
			...
			return (ZK.Model.ZK_FileVisitors)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ZK_FileVisitors> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ZK_FileVisitors> DataTableToList(DataTable dt)
		{
			List<ZK.Model.ZK_FileVisitors> modelList = new List<ZK.Model.ZK_FileVisitors>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.ZK_FileVisitors model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.ZK_FileVisitors();
