...
namespace ZK.BLL
{
	...
	{
		private readonly IOFFGROUPSUPEROBJS dal=DataAccess.CreateOFFGROUPSUPEROBJS();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.OFFGROUPSUPEROBJS GetModelByCache(long SID)
		{
			
			string CacheKey = "OFFGROUPSUPEROBJSModel-" + SID;
			...
			return (ZK.Model.OFFGROUPSUPEROBJS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.OFFGROUPSUPEROBJS> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.OFFGROUPSUPEROBJS> DataTableToList(DataTable dt)
		{
			List<ZK.Model.OFFGROUPSUPEROBJS> modelList = new List<ZK.Model.OFFGROUPSUPEROBJS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.OFFGROUPSUPEROBJS model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.OFFGROUPSUPEROBJS();
					...
					if(dt.Rows[n]["SUPEROBJCODE"]!=null && dt.Rows[n]["SUPEROBJCODE"].ToString()!="")
					{
					model.SUPEROBJCODE=dt.Rows[n]["SUPEROBJCODE"].ToString();
					}
