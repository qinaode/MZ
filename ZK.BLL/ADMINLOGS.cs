...
namespace ZK.BLL
{
	...
	{
		private readonly IADMINLOGS dal=DataAccess.CreateADMINLOGS();
		public ADMINLOGS()
		{}
		#region  Method
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.ADMINLOGS GetModelByCache(long SID)
		{
			
			string CacheKey = "ADMINLOGSModel-" + SID;
			...
			return (ZK.Model.ADMINLOGS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ADMINLOGS> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ADMINLOGS> DataTableToList(DataTable dt)
		{
			List<ZK.Model.ADMINLOGS> modelList = new List<ZK.Model.ADMINLOGS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.ADMINLOGS model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.ADMINLOGS();
					...
					if(dt.Rows[n]["IPADDR"]!=null && dt.Rows[n]["IPADDR"].ToString()!="")
					{
