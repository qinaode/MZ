...
namespace ZK.BLL
{
	...
	/// JOINRESPONSES
	/// </summary>
	public partial class JOINRESPONSES
	{
		private readonly IJOINRESPONSES dal=DataAccess.CreateJOINRESPONSES();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.JOINRESPONSES GetModelByCache(long SID)
		{
			
			string CacheKey = "JOINRESPONSESModel-" + SID;
			...
			return (ZK.Model.JOINRESPONSES)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.JOINRESPONSES> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.JOINRESPONSES> DataTableToList(DataTable dt)
		{
			List<ZK.Model.JOINRESPONSES> modelList = new List<ZK.Model.JOINRESPONSES>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.JOINRESPONSES model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.JOINRESPONSES();
