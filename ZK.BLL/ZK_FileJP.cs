...
namespace ZK.BLL
{
	...
	{
		private readonly IZK_FileJP dal=DataAccess.CreateZK_FileJP();
		public ZK_FileJP()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.ZK_FileJP GetModelByCache(int ID)
		{
			
			string CacheKey = "ZK_FileJPModel-" + ID;
			...
			return (ZK.Model.ZK_FileJP)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ZK_FileJP> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.ZK_FileJP> DataTableToList(DataTable dt)
		{
			List<ZK.Model.ZK_FileJP> modelList = new List<ZK.Model.ZK_FileJP>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.ZK_FileJP model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.ZK_FileJP();
