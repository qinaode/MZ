...
namespace ZK.BLL
{
	...
	/// file_collection
	/// </summary>
	public partial class public_files
	{
		private readonly Ipublic_files dal=DataAccess.Createpublic_files();
        public public_files()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        public ZK.Model.public_files GetModelByCache(int id)
		{
            ...
            return (ZK.Model.public_files)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
        public List<ZK.Model.public_files> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
        public List<ZK.Model.public_files> DataTableToList(DataTable dt)
		{
            List<ZK.Model.public_files> modelList = new List<ZK.Model.public_files>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                ZK.Model.public_files model;
				for (int n = 0; n < rowsCount; n++)
				{
                    model = new ZK.Model.public_files();
