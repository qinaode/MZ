...
namespace ZK.BLL
{
	...
	{
		private readonly Iminiyun_tags dal=DataAccess.Createminiyun_tags();
		public miniyun_tags()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.miniyun_tags GetModelByCache(int id)
		{
			
			string CacheKey = "miniyun_tagsModel-" + id;
			...
			return (ZK.Model.miniyun_tags)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_tags> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_tags> DataTableToList(DataTable dt)
		{
			List<ZK.Model.miniyun_tags> modelList = new List<ZK.Model.miniyun_tags>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.miniyun_tags model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.miniyun_tags();
