...
namespace ZK.BLL
{
	...
	{
		private readonly IJOINREQUESTS dal=DataAccess.CreateJOINREQUESTS();
		public JOINREQUESTS()
		{}
		#region  Method
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.JOINREQUESTS GetModelByCache(long SID)
		{
			
			string CacheKey = "JOINREQUESTSModel-" + SID;
			...
			return (ZK.Model.JOINREQUESTS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.JOINREQUESTS> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.JOINREQUESTS> DataTableToList(DataTable dt)
		{
			List<ZK.Model.JOINREQUESTS> modelList = new List<ZK.Model.JOINREQUESTS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.JOINREQUESTS model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.JOINREQUESTS();
