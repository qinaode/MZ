...
{
	/// <summary>
	/// miniyun_file_version_metas
	/// </summary>
	public partial class miniyun_file_version_metas
	{
		private readonly Iminiyun_file_version_metas dal=DataAccess.Createminiyun_file_version_metas();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.miniyun_file_version_metas GetModelByCache(int id)
		{
			
			string CacheKey = "miniyun_file_version_metasModel-" + id;
			...
			return (ZK.Model.miniyun_file_version_metas)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_file_version_metas> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_file_version_metas> DataTableToList(DataTable dt)
		{
			List<ZK.Model.miniyun_file_version_metas> modelList = new List<ZK.Model.miniyun_file_version_metas>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.miniyun_file_version_metas model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.miniyun_file_version_metas();
