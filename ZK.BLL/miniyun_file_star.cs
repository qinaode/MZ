...
namespace ZK.BLL
{
	...
	/// miniyun_file_star
	/// </summary>
	public partial class miniyun_file_star
	{
		private readonly Iminiyun_file_star dal=DataAccess.Createminiyun_file_star();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ZK.Model.miniyun_file_star GetModelByCache(int id)
		{
			
			string CacheKey = "miniyun_file_starModel-" + id;
			...
			return (ZK.Model.miniyun_file_star)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_file_star> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ZK.Model.miniyun_file_star> DataTableToList(DataTable dt)
		{
			List<ZK.Model.miniyun_file_star> modelList = new List<ZK.Model.miniyun_file_star>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ZK.Model.miniyun_file_star model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ZK.Model.miniyun_file_star();
