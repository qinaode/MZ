<%@ Page Title="" Language="C#" MasterPageFile="~/ZKManage.Master" AutoEventWireup="true"
    CodeBehind="MoralResourceManage.aspx.cs" Inherits="ZK.Manage.MoralManagement.MoralResourceManage" %>
...
<%--
    ...
    <script src="../js/moralaresourceManage.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    <div class="content">
        ...
        <div class="pageInfo" align="left">
            名称：<input type="text" id="text_MoralResourceName" />&nbsp;&nbsp;&nbsp; 德育分类：<input
                type="text" id="txt_channelGroupName" />
            &nbsp;&nbsp;<input type="button" id="btn_Search" value="搜索" onclick="GetMoralResourceListByCondition()" />
        </div>
