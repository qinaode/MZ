...
{
    public partial class AdministrativeManageCategory : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string strSQL = "channelId=" + 3 + " And " + "channelGroupName=" + "'txtCategoryName.Text'";
        ...
        private void ChannelGroupDataBind()
        {
            ...
            string strSQL = "channelId=" + 3 + " order by channelGroupParent,channelGroupLevel";
            System.Data.DataSet ds = bllChannelGroup.GetList(strSQL);
        ...
        private void Delect(int id)
        {
            ...
            string strSQL = "channelId=" + 3 + " and channelGroupParent= "+id ;
            System.Data.DataSet ds = bllChannelGroup.GetList(strSQL);
